...
(function() {
  ...
  NeatComplete.Dispatch = (function() {
    ...
    Dispatch.prototype.setOption = function(name, value) {
      this.options[name] = value;
      return this;
    };

    Dispatch.prototype.getOption = function(name) {
  ...
  NeatComplete._Result = (function() {
    ...
    _Result.prototype.render = function() {
      ...
      this.li.setAttribute("class", this.widget.options.item_class);
      this.addEvents();
      return this.li;
    };
  ...
  NeatComplete._Service = (function(_super) {

    __extends(_Service, _super);
  ...
  NeatComplete.Widget = (function(_super) {
    ...
    function Widget(element, options) {
      ...
      this.output.setAttribute("class", this.options.list_class);
    ...
    Widget.prototype.addService = function(name, search_function, options) {
      ...
      this.services.push(new NeatComplete._Service(this, name, search_function, options));
      return this;
    };
    ...
    Widget.prototype._renderFooter = function() {
      return this._renderItem(this.options.footerContent, this.options.footer_class);
    };

    Widget.prototype._renderEmpty = function() {
      return this._renderItem(this.options.emptyContent, this.options.empty_class);
    };
    ...
    Widget.prototype.showResults = function() {
      ...
      if (this._servicesReady()) {
        ...
        if (this.results.length) {
          ...
          if ((this.options.footerContent != null) && (footer = this._renderFooter()) !== "") {
