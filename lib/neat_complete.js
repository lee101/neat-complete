(function() {
  ...
  if ((_ref = window.NeatComplete) == null) {
    window.NeatComplete = {};
  }
  ...
  NeatComplete.Dispatch = (function() {
    ...
    Dispatch.prototype.on = function(event_name, callback) {
      ...
      if ((_ref1 = this.subs) == null) {
        this.subs = {};
      }
      if ((_ref2 = (_base = this.subs)[event_name]) == null) {
        _base[event_name] = [];
      }
    ...
    Dispatch.prototype.trigger = function() {
      var args, callback, event_name, _i, _len, _ref1, _ref2;

      event_name = arguments[0], args = 2 <= arguments.length ? __slice.call(arguments, 1) : [];
      if (((_ref1 = this.subs) != null ? _ref1[event_name] : void 0) != null) {
        _ref2 = this.subs[event_name];
...
(function() {
  ...
  NeatComplete._Result = (function() {
    function _Result(service, options) {
      ...
      this.value = (_ref1 = this.options) != null ? _ref1.value : void 0;
      this.score = ((_ref2 = this.options) != null ? _ref2.score : void 0) || 0;
      this.identifier = (_ref3 = this.options) != null ? _ref3.identifier : void 0;
      this.data = ((_ref4 = this.options) != null ? _ref4.data : void 0) || {};
    }
    ...
    _Result.prototype.highlight = function() {
      ...
      if ((_ref1 = this.widget.highlighted) != null) {
        _ref1.unhighlight();
      }
...
(function() {
  ...
  NeatComplete.Widget = (function(_super) {
    ...
    function Widget(element, options) {
      ...
      this.options = options != null ? options : {};
      this._getSuggestions = __bind(this._getSuggestions, this);
    ...
    Widget.prototype._onKeyDown = function(e) {
      ...
      switch (keyCode) {
        ...
        default:
          ...
          return this._timeout = setTimeout(this._getSuggestions, 400);
      }
    };
    ...
    Widget.prototype._renderItem = function(content, cls) {
      ...
      NeatComplete.addDomEvent(item, "mousedown", function() {
        return _this.mouseDownOnSelect = true;
      });
      NeatComplete.addDomEvent(item, "mouseup", function() {
